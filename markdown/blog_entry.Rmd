...
read_csv2(file="https://raw.githubusercontent.com/werkstattcodes/Bosnia_MP_voting_behavior/master/data/df_ocr_results_unnested.csv") %>%
  kable() %>%   
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), fixed_thead = T, font_size = 10) %>%
  scroll_box(width = "100%", height = "200px")
...
For future research the obtaind dataset is made available [here](https://github.com/werkstattcodes/Bosnia_MP_voting_behavior/blob/master/data/df_ocr_results_unnested.csv){target="_blank"}.
